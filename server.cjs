...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Multi-Agency Child Welfare Crisis Coordination System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Crisis Case Management";
process.env.TABLE_NAME = process.env.TABLE_NAME || "crisis_case_management_records";
'use strict';
